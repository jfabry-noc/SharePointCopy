 ...
 * @returns {object}
 */
function getSpoContent(endpoint, accessToken) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, axios_1.default.get(endpoint, options)];
                case 2:
                    response = _a.sent();
                    return [2 /*return*/, response.data];
                case 3:
                    error_1 = _a.sent();
                    (0, logging_1.logTime)("Failed to query endpoint with error: ".concat(error_1), logging_1.LogLevels.ERROR);
                    return [3 /*break*/, 4];
